      ...
      <div class="row justify-content-center pb-5">
        <div class="col-2 d-flex justify-content-center align-items-center">
          <a class="btn es_button d-flex justify-content-center align-items-center" href="##">
            Read More
            <svg width="16px" class="svg-inline--fa fa-right-long ps-1" aria-hidden="true" focusable="false"
        ...
        <!-- /.col-2 -->
        <div class="col-1">
          <a style="padding: 2rem; scale: .6;"
            class="btn es_button d-flex align-items-center justify-content-center rounded-circle" href="###">
            <svg width="16px" class="svg-inline--fa fa-play" aria-hidden="true" focusable="false" data-prefix="fas"
