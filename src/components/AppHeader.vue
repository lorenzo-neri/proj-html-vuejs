                    ...
                    <div class="col-3 d-flex justify-content-end gap-2">
                        ...
                        <a href="##">
                            <div class="circle_icon_light">
                                <svg class="svg-inline--fa fa-magnifying-glass p-2" aria-hidden="true" focusable="false"
                        ...
                        <a href="##">
                            <div class="circle_icon_light">
                                <svg class="svg-inline--fa fa-bag-shopping p-2" aria-hidden="true" focusable="false"
        ...
        <div class="container pb-5">
            <div class="row pt-5 mt-5 justify-content-start">
                ...
                <div class="col-1 d-flex flex-column gap-2">
                    ...
                    <a href="##">
                        <svg width="1rem" class="svg-inline--fa fa-twitter circle_icon_dark p-2" aria-hidden="true"
                    ...
                    <a href="##">
                        <svg width="1rem" class="svg-inline--fa fa-linkedin circle_icon_dark p-2" aria-hidden="true"
            ...
            <div id="buttons_jumbo" class="row justify-content-center pb-5">
                ...
                <div class="col-1">
                    <a style="padding: 2rem; scale: .7;"
                        ...
                        <svg width="1rem" class="svg-inline--fa fa-play" aria-hidden="true" focusable="false"
